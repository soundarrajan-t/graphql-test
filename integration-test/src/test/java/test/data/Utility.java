...
public class Utility {
    ...
    public static final String GRAPHQL_QUERY_REQUEST_PATH = "request/";
    public static final String GRAPHQL_QUERY_RESPONSE_PATH = "response/";
    ...
    public static String readFromResource(String resourcePath) {
        try (InputStream in = Utility.class.getClassLoader().getResourceAsStream(resourcePath)) {
            assert in != null;
